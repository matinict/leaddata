...
# Activate your project venv (or uv)
...
> To cache it in your project instead:
...
tts.tts_to_file(
    ...
    speaker_wav="assets/voices/matin.wav",
    language="en",
    file_path=".runtime/output/test_clone.wav"
)
print("Done — check .runtime/output/test_clone.wav")
EOF
```
### First test
...
os.makedirs(".runtime/output", exist_ok=True)
...
tts.tts_to_file(
    ...
    speaker_wav="assets/voices/matin.wav",
    language="en",
    file_path=".runtime/.runtime/output/test_clone.wav"
)
print("Done — .runtime/.runtime/output/test_clone.wav")
EOF
EOF
```
...
```bash
# RVC via inference only (no training on this machine)
pip install "rvc-python"

# Or clone the lightweight inference fork
git clone https://github.com/RVC-Project/Retrieval-based-Voice-Conversion-WebUI \
    /var/POAi/CrewAiFlow/cf2/vendor/rvc
cd /var/POAi/CrewAiFlow/cf2/vendor/rvc
...
cd /var/POAi/CrewAiFlow/cf2/vendor/stylettsz
pip install -r requirements.txt
...
cd /var/POAi/CrewAiFlow/cf2/vendor/openvoice
pip install -e .
